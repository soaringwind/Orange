    ...
    <section class="todoapp">
      ...
      <section class="main" v-show="todos.length">
        ...
        <transition-group name="staggered-fade" tag="ul" v-bind:css="false" v-on:before-enter="beforeEnter"
          v-on:enter="enter" v-on:leave="leave" class="todo-list">
          <!-- 查看所有备忘 -->
          ...
          <li v-for="todo in computedTodos" class="todo" :key="todo.id" :class="{ completed: todo.completed }">
            ...
            <!-- 监听 delete 事件 -->
            <todo-item v-model:propName:title.sync="todo.title" v-model:propName:completed.sync="todo.completed"
        ...
        <footer class="footer" v-show="todos.length">
          <span class="todo-count">
            ...
            <strong>{{ remaining }}</strong> {{ computedRemainPlur(remaining) }} left
          </span>
